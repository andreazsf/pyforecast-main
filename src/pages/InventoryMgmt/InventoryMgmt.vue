    ...
    <q-page class="flex flex-center bg-white">
      ...
      >
        ...
        >
          ...
          >
            <div
              class="my-text-accent-2 row full-width justify-between"
              :class="$q.screen.width <= 414 ? '' : ' q-mb-lg'"
            >
              <q-list
                class="justify-end"
                :class="`${$q.screen.width <= 414 ? 'col' : 'row'} ${
                  $q.screen.width <= 820 ? 'q-gutter-x-xs' : 'q-gutter-x-md'
                }`"
              >
                <q-item
                  clickable
              ...
              <q-list
                class="justify-end q-mt-sm q-mr-md"
                :class="$q.screen.width <= 414 ? 'col-auto' : 'row'"
              >
                <div
                  :class="
                    $q.screen.width <= 414
                  ...
                  "
                >
                  <div :class="$q.screen.width <= 414 ? 'row' : ''">
                    <q-btn
                      no-caps
                      flat
                      icon="query_stats"
                  ...
                  <div :class="$q.screen.width <= 414 ? 'col' : ''">
                    <q-btn
                      no-caps
                      flat
                      icon="playlist_add"
                ...
                <q-form>
                  <q-card-section class="q-pb-lg q-mb-md q-gutter-y-md text-16">
                    <div class="row q-gutter-x-lg">
                      <div class="col">
                        <div class="text-black q-mb-sm">Product Name</div>
                        <q-input
                    ...
                    <div class="row q-gutter-x-lg">
                      <div class="col">
                        <div class="text-black q-mb-sm">Quantity Sold</div>
                        <q-input
                          ...
                          autocomplete="off"
                          class="input-type q-px-lg"
                          placeholder="Enter quantity of sold items"
                          type="number"
...
<script src="src/pages/InventoryMgmt/scripts/InventoryMgmt.js"></script>
