    ...
    >
      ...
      >
        ...
        >
          <!-- Heading -->
          <div>
            <div class="text-h3" v-if="productName !== ''">
              Inventory | {{ productName }}
            </div>
            <div class="text-h3" v-else>Inventory</div>
            <p class="text-grey-6 q-mt-sm">
              Here, you can view the forecasted inventory data.
            </p>
          </div>
          ...
          <div class="text-16">
            ...
            <div :class="{ 'styled-content': isButtonClicked }">
              ...
              >
                ...
                >
                  <p class="q-ml-md">
                    ...
                    />
                    <b>Hover data points</b> to see inventory values.
                  </p>
                </div>
                <!-- Errors -->
                <div
              ...
              <!-- Inventory Data, and Forecasted Values -->
...
<script src="src/pages/InventoryMgmt/scripts/ForecastInventory.js"></script>
